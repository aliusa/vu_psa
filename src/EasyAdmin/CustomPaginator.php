...
final class CustomPaginator implements EntityPaginatorInterface
{
    private $adminUrlGenerator;
    private $currentPage;
    private $pageSize;
    private $rangeSize = 3;
    private $rangeEdgeSize = 1;
    private $results;
    private $numResults;

    public function __construct(AdminUrlGenerator $adminUrlGenerator, int $itemsTotal, int $wrap, int $currentPage)
    {
        $this->adminUrlGenerator = $adminUrlGenerator;
        $this->pageSize = $wrap;
        $this->numResults = $itemsTotal;
