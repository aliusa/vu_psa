...
class ServicesCategoriesCrudController extends AbstractCrudController
{
    ...
    {
        return ServicesCategories::class;
    }
    ...
    public function configureCrud(Crud $crud): Crud
    {
        ...
        $crud
            ...
            ->setEntityLabelInSingular(function (?ServicesCategories $entity, ?string $pageName) {
                return match ($pageName) {
                    Crud::PAGE_INDEX, Crud::PAGE_NEW => 'Paslaugų kategoriją',
                    Crud::PAGE_EDIT => "Paslaugų kategorija #{$entity->getId()}",
                    Crud::PAGE_DETAIL => $entity->__tostring(),
                    default => 'Paslaugų kategorijos',
                };
            })
            ->setEntityLabelInPlural('Paslaugų kategorijos')
        ;
